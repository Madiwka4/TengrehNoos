...
{
    /// <inheritdoc />
    public partial class addetags4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsArticlesId = table.Column<int>(type: "integer", nullable: false),
                    TagsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsArticleTag", x => new { x.NewsArticlesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_NewsArticleTag_NewsArticles_NewsArticlesId",
